% XXXXXXXXXXXXXXXXXXXXXXXXXXX sus_cri XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
%
% Author    :   Susanti
% Date      :   Aug 1 2014
% Function  :
% Syntax    :   sus_cri(data_input, net)
%
%
% Algorithm -
% XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

function y = sus_cri(data_input, net)

    %disp('sus_cri');
    num_outputs = size(net.output, 2);
    y = zeros(num_outputs);

    if net.num_active_rules == 0
        return;
    end
    ...
    for i = 1 : num_rules
        ...
        for j = 1 : num_attributes
            if net.rule(i).antecedent(j) == 0
                ...
                % 'continue' if sigma for the gaussian mf is 0
    ...
    y = struct();
    y.rule_firing_strength = rule_firing_strength;
    y.numer = numer;
    y.denom = denom;
