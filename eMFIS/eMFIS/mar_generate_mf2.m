% XXXXXXXXXXXXXXXXXXXXXXXXXXX MAR_GENERATE_MF2 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
% 
% Author    :   Mario Hartanto
% Date      :   Jan 24 2014
% Function  :   generates MF
% Syntax    :   mar_generateMF2(data_struct, data_value, current_count)
% 
...
function D = mar_generate_mf2(data_struct, data_value, current_count, data_size, default_width)

    disp(['Generate MF2 ', num2str(current_count)]);
...
%     end
    ...
    new_struct.mf(new_mf).age = zeros(data_size);
