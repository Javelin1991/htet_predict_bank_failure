...
% Syntax    :   mar_trainOnline (data_input, data_target, algo, varargin)
% 
...
function D = mar_trainOnline(data_input, data_target, algo, max_cluster, half_life, threshold_mf, min_rule_weight, varargin)   
    ...
    if isempty(varargin)
        ...
        system.net.ruleCount = zeros(size(data_target,1), 1);
