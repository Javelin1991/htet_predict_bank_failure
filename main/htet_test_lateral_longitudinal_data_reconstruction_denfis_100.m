...
%
% The postfix "_denfis_100" in the filename indicates the pretrained systems that are used for reconstruction is of DENFIS
...
function [result, rc1] = do_lateral_prediction(A, SYSTEMS, bank_type)
  ...
  % to retreat the best pretrained system which is denfis
