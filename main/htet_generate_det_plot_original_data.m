    ...
    for i=1:5
        switch j
            case 1
                ...
                mean_eer_original_data = mean_eer_original_data + net_result_for_last_record(i).output.MIN_EER(1,1);
            ...
            case 2
                ...
                mean_eer_original_data = mean_eer_original_data + net_result_for_one_year_prior(i).output.MIN_EER(1,1);
                plot(fnr, fpr, color_str(i)); % plot the matrix
            ...
            case 3
                ...
                mean_eer_original_data = mean_eer_original_data + net_result_for_two_year_prior(i).output.MIN_EER(1,1);
                plot(fnr, fpr, color_str(i)); % plot the matrix
